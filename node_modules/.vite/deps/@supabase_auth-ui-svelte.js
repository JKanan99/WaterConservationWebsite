...
function add_css(target) {
  append_styles(target, "svelte-ll2s9h", "button.svelte-ll2s9h{display:flex;align-items:center;justify-content:center;gap:8px;border-radius:var(--radii-borderRadiusButton);font-size:var(--fontSizes-baseButtonSize);padding:var(--space-buttonPadding);cursor:pointer;border-width:var(--borderWidths-buttonBorderWidth);border-style:solid;width:100%;transition-property:background-color;transition-timing-function:cubic-bezier(0.4, 0, 0.2, 1);transition-duration:100ms}button.default.svelte-ll2s9h{background-color:var(--colors-defaultButtonBackground);color:var(--colors-defaultButtonText);border-color:var(--colors-defaultButtonBorder)}button.default.svelte-ll2s9h:hover{background-color:var(--colors-defaultButtonBackgroundHover)}button.primary.svelte-ll2s9h{background-color:var(--colors-brand);color:var(--colors-brandButtonText);border-color:var(--colors-brandAccent)}button.primary.svelte-ll2s9h:hover{background-color:var(--colors-brandAccent)}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */");
}
function create_fragment2(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(button, file2, 6, 0, 205);
    },
    m: function mount(target, anchor) {
    ...
    p: function update(ctx2, [dirty]) {
      ...
      set_attributes(button, button_data = get_spread_update(button_levels, [
        ...
        (!current || dirty & /*classNames*/
        2 && button_class_value !== (button_class_value = /*classNames*/
        ctx2[1].join(" "))) && { class: button_class_value }
      ]));
      toggle_class(button, "svelte-ll2s9h", true);
    },
    i: function intro(local) {
...
function instance2($$self, $$props, $$invalidate) {
  ...
  $$self.$$.update = () => {
    ...
    9) {
      $:
        $$invalidate(1, classNames = generateClassNames("button", color, appearance));
    }
  };
  return [appearance, classNames, $$restProps, color, $$scope, slots, click_handler];
}
var Button = class extends SvelteComponentDev {
  constructor(options) {
    super(options);
    init(this, options, instance2, create_fragment2, safe_not_equal, { color: 3, appearance: 0 }, add_css);
    dispatch_dev("SvelteRegisterComponent", {
      component: this,
      tagName: "Button",
      options,
...
function add_css2(target) {
  append_styles(target, "svelte-nm5p4o", "form.svelte-nm5p4o{width:100%}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64,eyJ2ZXJzaW9uIjozLCJmaWxlIjoiRW1haWxBdXRoLnN2ZWx0ZSIsIm1hcHBpbmdzIjoiQUFtSkMsa0JBQUssQ0FDSixLQUFLLENBQUUsSUFDUiIsIm5hbWVzIjpbXSwic291cmNlcyI6WyJFbWFpbEF1dGguc3ZlbHRlIl19 */");
}
function create_default_slot_11(ctx) {
  ...
  dispatch_dev("SvelteRegisterBlock", {
    ...
    type: "slot",
    source: '(58:4) <Label for=\\"email\\" {appearance}>',
    ctx
  });
  return block;
}
function create_default_slot_10(ctx) {
  ...
  dispatch_dev("SvelteRegisterBlock", {
    ...
    type: "slot",
    source: '(71:4) <Label for=\\"password\\" {appearance}>',
    ctx
  });
  return block;
}
function create_default_slot_9(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      add_location(div0, file7, 56, 3, 1930);
      add_location(div1, file7, 69, 3, 2235);
    },
    m: function mount(target, anchor) {
  ...
  dispatch_dev("SvelteRegisterBlock", {
    ...
    type: "slot",
    source: '(56:2) <Container direction=\\"vertical\\" gap=\\"large\\" {appearance}>',
    ctx
  });
  return block;
}
function create_default_slot_8(ctx) {
  ...
  dispatch_dev("SvelteRegisterBlock", {
    ...
    type: "slot",
    source: '(83:2) <Button type=\\"submit\\" color=\\"primary\\" {appearance}>',
    ctx
  });
  return block;
}
...
function create_if_block_4(ctx) {
  ...
  dispatch_dev("SvelteRegisterBlock", {
    ...
    type: "if",
    source: "(87:4) {#if authView === VIEWS.SIGN_IN && magicLink}",
    ctx
  });
  return block;
}
function create_default_slot_7(ctx) {
  ...
  dispatch_dev("SvelteRegisterBlock", {
    ...
    type: "slot",
    source: '(88:5) <Anchor       on:click={(e) => {        e.preventDefault();        authView = VIEWS.MAGIC_LINK;       }}       href=\\"#auth-magic-link\\"       {appearance}       >',
    ctx
  });
  return block;
}
...
function create_if_block_3(ctx) {
  ...
  dispatch_dev("SvelteRegisterBlock", {
    ...
    type: "if",
    source: "(98:4) {#if authView === VIEWS.SIGN_IN}",
    ctx
  });
  return block;
}
function create_default_slot_6(ctx) {
  ...
  dispatch_dev("SvelteRegisterBlock", {
    ...
    type: "slot",
    source: '(120:5) <Anchor       on:click={(e) => {        e.preventDefault();        authView = VIEWS.SIGN_IN;       }}       href=\\"#auth-sign-in\\"       {appearance}      >',
    ctx
  });
  return block;
}
function create_default_slot_5(ctx) {
  ...
  dispatch_dev("SvelteRegisterBlock", {
    ...
    type: "slot",
    source: '(99:5) <Anchor       on:click={(e) => {        e.preventDefault();        authView = VIEWS.FORGOTTEN_PASSWORD;       }}       href=\\"#auth-forgot-password\\"       {appearance}      >',
    ctx
  });
  return block;
}
function create_default_slot_4(ctx) {
  ...
  dispatch_dev("SvelteRegisterBlock", {
    ...
    type: "slot",
    source: '(109:5) <Anchor       on:click={(e) => {        e.preventDefault();        authView = VIEWS.SIGN_UP;       }}       href=\\"#auth-sign-up\\"       {appearance}      >',
    ctx
  });
  return block;
}
function create_default_slot_3(ctx) {
  ...
  dispatch_dev("SvelteRegisterBlock", {
    ...
    type: "slot",
    source: '(86:3) <Container direction=\\"vertical\\" gap=\\"small\\" {appearance}>',
    ctx
  });
  return block;
}
function create_default_slot_2(ctx) {
  ...
  dispatch_dev("SvelteRegisterBlock", {
    ...
    type: "slot",
    source: '(55:1) <Container direction=\\"vertical\\" gap=\\"large\\" {appearance}>',
    ctx
  });
  return block;
}
...
function create_default_slot_1(ctx) {
  ...
  dispatch_dev("SvelteRegisterBlock", {
    ...
    type: "slot",
    source: "(136:2) <Message {appearance}>",
    ctx
  });
  return block;
}
...
function create_default_slot(ctx) {
  ...
  dispatch_dev("SvelteRegisterBlock", {
    ...
    type: "slot",
    source: '(141:2) <Message color=\\"danger\\" {appearance}>',
    ctx
  });
  return block;
}
function create_fragment7(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(form, file7, 53, 0, 1747);
    },
    m: function mount(target, anchor) {
    ...
    p: function update(ctx2, [dirty]) {
      ...
      64)
        container_changes.appearance = /*appearance*/
        ctx2[6];
      if (dirty & /*$$scope, appearance, authView, i18n, magicLink, showLinks, password, email*/
      1048703) {
        container_changes.$$scope = { dirty, ctx: ctx2 };
      }
      container.$set(container_changes);
...
function instance7($$self, $$props, $$invalidate) {
  let { $$slots: slots = {}, $$scope } = $$props;
  validate_slots("EmailAuth", slots, []);
  ...
  $$self.$$set = ($$props2) => {
    ...
    if ("supabaseClient" in $$props2)
      $$invalidate(11, supabaseClient = $$props2.supabaseClient);
    if ("redirectTo" in $$props2)
      $$invalidate(12, redirectTo = $$props2.redirectTo);
  ...
  $$self.$inject_state = ($$props2) => {
    ...
    if ("lngKey" in $$props2)
      $$invalidate(9, lngKey = $$props2.lngKey);
  };
  if ($$props && "$$inject" in $$props) {
    $$self.$inject_state($$props.$$inject);
  }
...
var file13 = "node_modules/@supabase/auth-ui-svelte/dist/Auth/Auth.svelte";
function create_if_block_52(ctx) {
  ...
  dispatch_dev("SvelteRegisterBlock", {
    ...
    type: "if",
    source: "(43:1) {#if view === VIEWS.SIGN_IN}",
    ctx
  });
  return block;
}
function create_if_block_62(ctx) {
  ...
  dispatch_dev("SvelteRegisterBlock", {
    ...
    type: "if",
    source: "(56:2) {#if !onlyThirdPartyProviders}",
    ctx
  });
  return block;
}
function create_if_block_33(ctx) {
  ...
  dispatch_dev("SvelteRegisterBlock", {
    ...
    type: "if",
    source: "(68:1) {#if view === VIEWS.SIGN_UP}",
    ctx
  });
  return block;
}
function create_if_block_43(ctx) {
  ...
  dispatch_dev("SvelteRegisterBlock", {
    ...
    type: "if",
    source: "(79:2) {#if !onlyThirdPartyProviders}",
    ctx
  });
  return block;
}
function create_if_block_27(ctx) {
  ...
  dispatch_dev("SvelteRegisterBlock", {
    ...
    type: "if",
    source: "(91:1) {#if view === VIEWS.FORGOTTEN_PASSWORD}",
    ctx
  });
  return block;
}
function create_if_block_19(ctx) {
  ...
  dispatch_dev("SvelteRegisterBlock", {
    ...
    type: "if",
    source: "(94:1) {#if view === VIEWS.MAGIC_LINK}",
    ctx
  });
  return block;
}
function create_if_block7(ctx) {
  ...
  dispatch_dev("SvelteRegisterBlock", {
    ...
    type: "if",
    source: "(97:1) {#if view === VIEWS.UPDATE_PASSWORD}",
    ctx
  });
  return block;
}
function create_fragment14(ctx) {
  ...
  let if_block0 = (
    /*view*/
    ctx[0] === VIEWS.SIGN_IN && create_if_block_52(ctx)
  );
  let if_block1 = (
    /*view*/
    ctx[0] === VIEWS.SIGN_UP && create_if_block_33(ctx)
  );
  let if_block2 = (
    /*view*/
    ctx[0] === VIEWS.FORGOTTEN_PASSWORD && create_if_block_27(ctx)
  );
  let if_block3 = (
    /*view*/
    ctx[0] === VIEWS.MAGIC_LINK && create_if_block_19(ctx)
  );
  let if_block4 = (
    /*view*/
    ctx[0] === VIEWS.UPDATE_PASSWORD && create_if_block7(ctx)
  );
  const block = {
    c: function create() {
      div = element("div");
    ...
    h: function hydrate() {
      ...
      add_location(div, file13, 41, 0, 1529);
    },
    m: function mount(target, anchor) {
      insert_hydration_dev(target, div, anchor);
      if (if_block0)
    ...
    p: function update(ctx2, [dirty]) {
      ...
      6144 && div_class_value !== (div_class_value = /*theme*/
      ctx2[11] !== "default" ? (
        /*themeVariables*/
        ctx2[12]
      ) : "")) {
...
function instance14($$self, $$props, $$invalidate) {
  ...
  $$self.$$set = ($$props2) => {
    ...
    if ("localization" in $$props2)
      $$invalidate(14, localization = $$props2.localization);
  };
  $$self.$capture_state = () => ({
    createStitches: X,
    createTheme: q,
  ...
  $$self.$inject_state = ($$props2) => {
    ...
    if ("themeVariables" in $$props2)
      $$invalidate(12, themeVariables = $$props2.themeVariables);
    if ("i18n" in $$props2)
  ...
  $$self.$$.update = () => {
    ...
    16384) {
      $:
        $$invalidate(13, i18n = merge(en_default, localization.variables ?? {}));
    }
    if ($$self.$$.dirty & /*appearance*/
    1024) {
      $:
    ...
    3072) {
      $:
        $$invalidate(12, themeVariables = q(merge(
          // @ts-ignore
...
export {
  ...
  EmailAuth_default as EmailAuth,
  ForgottenPassword_default as ForgottenPassword,
  MagicLink_default as MagicLink,
  SocialAuth_default as SocialAuth,
  UpdatePassword_default as UpdatePassword
};
